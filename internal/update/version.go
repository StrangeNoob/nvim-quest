...
// binary in place. Policy here (version comparison, throttling, whether to
// check) is pure and offline; the network and self-replace work lives in
// remote.go.
package update
...
// for a "dev" build or any unparseable version (used by the launch-time notice).
